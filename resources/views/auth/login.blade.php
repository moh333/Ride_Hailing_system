...
<head>
    ...
    <title>{{ config('app.name', 'Ride Hailing') }} - Login</title>
    <!-- Tailwind CSS CDN -->
...
<body class="h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="mx-auto flex justify-center">
            <div
                class="h-12 w-12 rounded-xl bg-gradient-to-br from-indigo-600 to-violet-600 flex items-center justify-center text-white font-bold text-2xl">
                R
            </div>
        </div>
